...
<body>
    ...
    <main>
        ...
        <section class="bg-white dark:bg-gray-900">
            <div class="py-2 px-4 mx-auto max-w-screen-xl sm:py-2 lg:px-6">
        ...
        <section class="bg-white dark:bg-gray-900">
            <div class="max-w-screen-xl px-4 py-6 mx-auto text-center lg:py-14 lg:px-6">
        ...
        <section class="bg-white dark:bg-gray-900">
            <div
                class="gap-8 items-center py-4 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-8 lg:px-6">
        ...
        <section class="bg-white dark:bg-gray-900">
            <div class="pt-12 px-4 mx-auto max-w-screen-xl lg:pt-12 lg:px-6 ">
                ...
                <div class="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
                    <div
                        ...
                        <div class="p-5">
                            ...
                            <p class="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">Bonnie drives the
        ...
        <section class="bg-white dark:bg-gray-900">
            <div class="pb-8 px-4 mx-auto max-w-screen-xl lg:pb-16 lg:px-6">
                <div class="max-w-screen-lg text-gray-500 sm:text-lg dark:text-gray-400">
                    {{-- <h2 class="mb-4 text-4xl tracking-tight font-bold text-gray-900 dark:text-white">Powering
                        innovation
                        at <span class="font-extrabold">200,000+</span> companies worldwide</h2> --}}
